...
">
			<h1>FACULTIES</h1>
			<p>WCE serves the national and international community through a broad spectrum of undergraduate studies..</p>
			<div class="row pt-3 pb-3">
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-10 m-auto">
					<div class="card card-margin">
						...
						<div class="card-body">
							<h5 class="card-title">Faculty of Electrical</h5>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-12 col-10 m-auto">
					<div class="card card-margin">
						...
						<div class="card-body">
							<h5 class="card-title">Faculty of Electronic</h5>
						</div>
					</div>
				</div>
			</div>
