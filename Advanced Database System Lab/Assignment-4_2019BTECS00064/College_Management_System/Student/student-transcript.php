...
<?php include "../common/common-header.php"?>
    <div class="container mt-4">
        <div class="text-danger text-center m-auto">
            <img src="../Images/wce_logo.png" alt="" width="100" height="100">
            <h4 class="text-dark mt-3">WALCHAND COLLEGE OF ENGINEERING - WCE</h4>
        </div>
    </div>
                        ...
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                <?php
                                    ...
                                    while ($row=mysqli_fetch_array($run)) {
                                        $session = $row['session'];
                                        $assign_date = date("Y", strtotime($row['admission_date']));;
                                    }
                                ?>
                                ...
                                <tr>
                                    ...
                                    <?php
                                        ...
                                        while($result_row = mysqli_fetch_array($run_result)){
                                            ...
                                            $assign_date = date("y", strtotime($result_row['admission_date']));
                                        }
                                    ?>
                        ...
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                <tr>
                                    <th colspan="2">Total Semester CH</th>
                                    <?php $total_semester_ch = $total_semester_ch + $total_ch; ?>
                                    <th><?php echo $total_ch=10; ?></th>
                                    <th></th>
                                    <th></th>
                                    <th></th>
                                </tr>
                                <tr>
                                    <th colspan="4">Semester GPA<?php echo $total_quality_points?></th>
                                    <?php $all_semester_quality_points = $all_semester_quality_points + $total_quality_points; ?>
                                    <th colspan="2"><?php echo  round($all_semester_quality_points/$total_ch, 2); ?></th>
                                </tr>
                            </table>
                        </div>
                    </section>
