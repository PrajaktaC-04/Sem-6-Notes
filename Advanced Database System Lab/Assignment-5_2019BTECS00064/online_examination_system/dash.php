...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link rel="shortcut icon" href="./image/wce_logo.png" type="image/x-icon">
    <title>Walchand College of Engineering Sangli DASHBOARD</title>
...
<body  style="background:lightgrey;">
  <div class="header">
    <div class="row">
      <div class="col-lg-6">
        <span class="logo">Walchand College of Engineering</span>
      </div>
      <?php
  ...
  <nav class="navbar navbar-default title1">
    <div class="container-fluid">
      ...
      <?php
        echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="account.php" class="log log1">'.$name.'</a>&nbsp;&nbsp;</span>';
      ?>
...
<table class="table table-striped title1" id="tblCustomers">
...
echo '</table></div></div><input type="button" class="pull-right btn" id="btnExport" value="Export" onclick="Export()" style="color: white; margin:0px; background:green">
...
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><t><b>S.N.</b></t><th><b>Subject</b></th><th><b>Email</b></th><th><b>Date</b></th><th><b>Time</b></th><th><b>By</b></th><th></th></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$date = $row['date'];
	...
	$id = $row['id'];
	 echo '<tr><td>'.$c++.'</td>';
	echo '<td><a title="Click to open feedback" href="dash.php?q=3&fid='.$id.'" style="color: red">'.$subject.'</a></td><td>'.$email.'</td><td>'.$date.'</td><td>'.$time.'</td><td>'.$name.'</td>
	';
...
echo ' 
<div class="row" style="background-image:url(image/bg1.jpg);background-repeat: no-repeat; background-size: cover; min-height:430px;">
